...
public:
  ...
  const Glyph& ascii_glyph(unsigned char code) const {
...
Glyph *make_glyph(const PNG& png, const Colour& fg, const Colour& bg, Font& font, uint x, uint y) {
...
void Display::set_colour(uint value) {
...
void Display::set_clear_colour(uint value) {
